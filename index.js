...
//
const BotName = 'B2KSans BoT ðŸ¤–'; // Nama Bot Whatsapp
const instagramlu = 'belum buat akun Instagram :V'; // Nama Instagramlu cok
const whatsapplu = '0896-4815-8528'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'belum buat grub:V'; // OFFICIAL GRUP LU 1
const grupch2 = 'belum buat grub:V'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Ahmad Ferdiansyah`)
})
